...
/**
 * @summary Create bundle sources, and write bundles + sourcemaps to disk
 */
...
/**
 * @summary Use RequireJS's resolver to find (and read) an AMD module on disk
 */
...
/**
 * @summary Create a single JS bundle, composed of n sources. Includes
 *          handling of plugins/shimming/etc
 * @todo The logic in this method is super bad and was rushed together. Should refactor
 */
...
/**
 * @summary Separate a RequireJS module ID from associated plugins
 */
...
/**
 * @summary Concatenate several module sources together,
 *          and create a sourcemap at the end
 */
